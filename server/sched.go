...
type Scheduler struct {
	...
	newServerFn  func(gpus gpu.GpuInfoList, model string, ggml *llm.GGML, adapters []string, projectors []string, opts api.Options, numParallel int, extramCmd string) (llm.LlamaServer, error)
